...
class ControleurCategorie extends ControleurObjet
{
    ...
    public static function creerCategorie()
    {
        ...
        if ($result) {
            header("Location: index.php?controleur=ControleurCategorie&action=lireObjets");
        } else {
            header("Location: index.php?controleur=ControleurCategorie&action=afficherFormulaireCreationObjet");
        }
    }

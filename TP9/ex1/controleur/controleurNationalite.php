...
class ControleurNationalite extends ControleurObjet
{
    ...
    public static function creerNationalite()
    {
        ...
        if ($result) {
            header("Location: index.php?controleur=ControleurNationalite&action=lireObjets");
        } else {
            header("Location: index.php?controleur=ControleurNationalite&action=afficherFormulaireCreationObjet");
        }
    }
    ...
    public static function modifierNationalite()
    {
        ...
        if ($result) {
            ...
            header("Location: indexs.php?controleur=ControleurNationalite&action=afficherFormulaireModificationObjet&numNationalite=" . $tableau[0]);
        }
    }

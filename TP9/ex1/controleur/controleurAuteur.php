...
class ControleurAuteur extends ControleurObjet
{
  ...
  public static function creerAuteur()
  {
    ...
    if ($result) {
      header("Location: index.php?controleur=ControleurAuteur&action=lireObjets");
    } else {
      header("Location: index.php?controleur=ControleurAuteur&action=afficherFormulaireCreationObjet");
    }
  }

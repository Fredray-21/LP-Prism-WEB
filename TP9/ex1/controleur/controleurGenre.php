...
class ControleurGenre extends ControleurObjet
{
    ...
    public static function creerGenre()
    {
        ...
        if ($result) {
            header("Location: index.php?controleur=ControleurGenre&action=lireObjets");
        } else {
            header("Location: index.php?controleur=ControleurGenre&action=afficherFormulaireCreationObjet");
        }
    }
    ...
    public static function modifierGenre()
    {
        ...
        if ($result) {
            ...
            header("Location: index.php?controleur=ControleurGenre&action=afficherFormulaireModificationObjet&numGenre=" . $tableau[0]);
        }
    }
}

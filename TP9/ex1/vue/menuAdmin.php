<div id="navigation">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            ...
            <a href="index.php?controleur=ControleurAdherent&action=afficherFormulaireCreationObjet">Créé un
                Adherents</a>
        </div>
    </div>
    <div class="dropdown">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            ...
            <a href="index.php?controleur=ControleurNationalite&action=afficherFormulaireCreationObjet">Créé un
                Nationalites</a>
        </div>
    </div>
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            ...
            <a href="index.php?controleur=ControleurCategorie&action=afficherFormulaireCreationObjet">Créé un
                Categories</a>
        </div>
    </div>
    ...
    <?php
    if ($_SESSION["login"]) {
        echo "<a class='dropbtn' href='index.php?controleur=ControleurAdherent&action=deconnecterAdherent'><i class='bi bi-box-arrow-in-right'></i> Se deconnecter</a>";
    }
    ?>
